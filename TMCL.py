...
class MotorManager:
    ...
    async def tmcl_command_sender(self):
        logging.debug("command_sender")
        while True:
            command, future = await self.command_queue.get()
            try:
                # Pass the future into send_command so data_received completes it
                r = self.protocol.send_command(command, future)
                if not future.done():
                    future.set_result(r)
            except Exception as e:
                if not future.done():
...
## TMCL COMMAND DEFINITION
    ...
    async def sap(self, addr, param, value):
        """
    ...
    async def stap(self, addr, param):
        """
    ...
    async def rsap(self, addr, param):
        """
    ...
    async def sgp(self, addr, param, bank, value):
        """
    ...
    async def ggp(self, addr, param, bank):
        """
    ...
    async def stgp(self, addr, param):
        """
    ...
    async def rsgp(self, addr, param):
        """
    ...
    async def sio(self, addr, param, value):
        """
    ...
    async def gio(self, addr, param, bank):
        """
    ...
    async def wait(self, addr, param, bank,value):
        """
